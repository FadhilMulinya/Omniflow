...
export const pricingPlans: PricingPlan[] = [
    {
        ...
        features: ['Up to 3 AI agents', '1,000 executions/month', 'Basic templates'],
        detailedFeatures: [
            'Up to 3 AI agents',
    ...
    },
    {
        ...
        features: ['Up to 10 AI agents', '5,000 executions/month', 'All templates'],
        popular: true,
        detailedFeatures: [
            'Up to 10 AI agents',
    ...
    },
    {
        ...
        features: ['Unlimited AI agents', 'Unlimited executions', 'Custom integrations'],
        detailedFeatures: [
            'Unlimited AI agents',
